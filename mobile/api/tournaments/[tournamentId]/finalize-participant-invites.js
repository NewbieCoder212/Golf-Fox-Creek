...
const { finalizeParticipantInvites } = require('../../../lib/tournament-invite');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const result = await finalizeParticipantInvites(String(tournamentId));
    if (result.error) {
    ...
    console.error('[finalize-participant-invites]', message);
